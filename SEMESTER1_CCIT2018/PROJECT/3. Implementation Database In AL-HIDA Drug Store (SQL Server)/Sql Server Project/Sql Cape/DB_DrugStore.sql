...
insert into tbMedicine values('ABNDZL','Albendazol','Pill','Clean worms and parasytes in the stomach','4','15000')
insert into tbMedicine values('ALPRNL','Alopurinol','Capsul','Reduce uric acid','5','30000')
insert into tbMedicine values('AMNFLN','Aminofilin','Injection/Pill','Asthma and Lung','6','45000')
insert into tbMedicine values('AZTRMS','Azitromisin','Pill/Capsul/Syrup','Bacterial infection','8','50000')
insert into tbMedicine values('ATNLL','Atenolol','Pill','Hypertension','5','65000')
insert into tbMedicine values('DXTRFN','Dextrofen','Syrup','Cough, Allergy','4','70000')
...
insert into tbSupplier values('32012000001','Michael Steve','New York, USA','082200000010','ABNDZL','50')
insert into tbSupplier values('32012000002','George Keel','California, USA','082200000020','ALPRNL','120')
insert into tbSupplier values('32012000003','Ed Kernel','London, England','082200000030','AMNFLN','40')
insert into tbSupplier values('32012000004','Curious Envy','Jakarta, Indonesia','082200000040','AZTRMS','60')
insert into tbSupplier values('32012000005','Connor Kenway','Shanghai, China','082200000050','ATNLL','90')
insert into tbSupplier values('32012000006','Roger Dave','Kuala Lumpur, Malaysia','082200000060','DXTRFN','220')
